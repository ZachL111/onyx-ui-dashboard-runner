...
$repo = "onyx-ui-dashboard-runner"
$language = "Lua"
$category = "Frontend apps"

foreach ($path in @("metadata/domain-review.json", "config/review-profile.json", "fixtures/domain_review.csv", "docs/field-notes.md", "docs/review-journal.md", "examples/onyx-ui-dashboard-walkthrough.md")) {
