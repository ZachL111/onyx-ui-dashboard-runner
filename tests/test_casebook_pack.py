"""Regression checks for the onyx-ui-dashboard-runner casebook."""
...
from casebook.harness import assert_expected, onyx_ui_dashboard_runner_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(onyx_ui_dashboard_runner_summary(), assert_expected())
